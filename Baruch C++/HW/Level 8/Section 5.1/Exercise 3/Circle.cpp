...
Circle::Circle(const Point c, const double r) : Shape(), centre(c), m_radius(r) {}  // constructor

Circle::Circle(const Circle& c) : Shape(c), centre(c.centre), m_radius(c.m_radius) {}  // copy constructor
